# -*- coding: utf-8 -*-
""" Classroom Exercise-Air Quality Index (AQI) Analysis Using Python.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/11s6NPm7nAVamPqpXjoxoKSe2It4pwPIi

<span style="color:black;font-size: 30px; font-family: Arial; font-weight: bold;">Air Quality Index Analysis Using Python </span>
...
CITY = 'Mumbai'  # You can replace this with any city you are interested in
